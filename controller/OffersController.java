...
public class OffersController {
    ...
    @FXML
    private TableView<?> externalsession;

    @FXML
    private TableColumn<?, ?> formula;
    ...
    private void initialize() {
        ...
        session.prefWidthProperty().bind(offerstable.widthProperty().multiply(0.25));
        price.prefWidthProperty().bind(offerstable.widthProperty().multiply(0.25));
        month.prefWidthProperty().bind(offerstable.widthProperty().multiply(0.25));
        formula.prefWidthProperty().bind(offerstable.widthProperty().multiply(0.25));

        Type.prefWidthProperty().bind(externalsession.widthProperty().multiply(0.5));
        Price.prefWidthProperty().bind(externalsession.widthProperty().multiply(0.5));
